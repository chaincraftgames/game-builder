...
2. **Automatic Transitions**: Hints for mechanicsGuidance ONLY
   ...
   - **Exception — init-phase transition** (fromPhase "init", id typically "initialize_game"): Hint stateDelta ops ONLY (rng for dice, setForAllPlayers for counts, set for game fields). NEVER hint mechanicsGuidance for this transition — the runtime applies stateDelta ops directly.

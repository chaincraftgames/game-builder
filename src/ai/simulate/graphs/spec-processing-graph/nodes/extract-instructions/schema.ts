...
export const AutomaticTransitionHintSchema = z.object({
  ...
  narrativeKeys: z.array(z.string()).optional().describe(
    "Keys from specNarratives that provide style/tone guidance for messages generated by this transition. Leave empty or omit if the game has no narratives or this transition generates no messages."
  ),
});
...
export const PhaseInstructionsHintSchema = z.object({
  ...
  phaseSummary: z.string().max(500).describe("Brief summary of what player input is needed"),
});
